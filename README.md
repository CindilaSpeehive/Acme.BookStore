...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 6a36d069-9e0d-43b4-8989-7b35d8f28c31
```

> `6a36d069-9e0d-43b4-8989-7b35d8f28c31` is the password of the certificate, you can change it to any password you want.
